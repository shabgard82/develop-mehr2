...
function HomeDrawer() {
  ...
  return (
    <>
      ...
      >
        <stack >
          <Stack display='flex' direction='row' justifyContent='space-between' alignItems='center' pt={4} pr={2} pl={2}>
          ...
          <Stack display='flex' direction='row' justifyContent='space-between' alignItems='center' pt={3} pr={2} pl={2}>
            <Stack display='flex' direction='row' alignItems='center'>
          ...
          <Stack display='flex' direction='row' justifyContent='space-between' alignItems='center' pt={3} pr={2} pl={2} pb={3}>
            <Stack display='flex' direction='row' alignItems='center'>
