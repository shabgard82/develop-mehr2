...
function StartCreateAccount() {
  ...
  const handleClick = () => navigate("/open-account");
  ...
  return (
    <Stack className={styles.all}>
      ...
      <Stack display="flex" direction="row" alignItems="center" justifyContent="space">
        <Stack>
          <img className={styles.img1} src={img1}></img>
        </Stack>
        <Stack pl={2}>
          <Stack>Original identity document</Stack>
          <Stack sx={{color:"gray"}}>[national card] or [Code+certificate]</Stack>
      ...
      <Stack display="flex" direction="row" alignItems="center" justifyContent="space">
        ...
        <Stack pl={2}>
          ...
          <Stack sx={{color:"gray"}}>recorded short and with specified text</Stack>
        </Stack>
      </Stack>
      <Stack pb={3}>
